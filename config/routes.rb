ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :promocoes
  map.resources :sustentabilidade, :singular => :sutentabilidade_item
  map.resources :home, :singular => :home_item
  map.resources :locacao, :singular => :locacao_item
  map.resources :assistencia, :singular => :assistencia_item
  map.resources :vendadireta, :singular => :vendadireta_item
